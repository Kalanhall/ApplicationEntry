...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of ApplicationEntry.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/kalanhall@163.com/ApplicationEntry'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'kalanhall@163.com' => 'wujm002@galanz.com' }
  s.source           = { :git => 'https://github.com/kalanhall@163.com/ApplicationEntry.git', :tag => s.version.to_s }
