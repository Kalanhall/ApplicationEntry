...
protocol TabItemBasicAnimation: TabItemAnimation {

    func imageOffsetAnimation(forTabBarItem item: TabBarButton) -> CAAnimation
    func imageMaskAnimation(forTabBarItem item: TabBarButton) -> CAAnimation
    func labelOffsetAnimation(forTabBarItem item: TabBarButton) -> CAAnimation
    func labelMaskAnimation(forTabBarItem item: TabBarButton) -> CAAnimation
    func dotScaleAnimation(forTabBarItem item: TabBarButton) -> CAAnimation

    var duration: Double { get }

}

extension TabItemBasicAnimation {

    func playAnimation(forTabBarItem item: TabBarButton, completion: (() -> Void)? = nil) {
